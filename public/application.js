...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://mangiatime.herokuapp.com',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetAllRecipes = function onGetAllRecipes(event) {
	  console.log(data);
	  var data = getFormFields(this);
	  event.preventDefault();
	  $('#change-password-alert').addClass('hidden');
	  api.getAllRecipes(data).then(ui.getAllRecipesSuccess).catch(ui.getAllRecipesFailure);
	};
	...
	var onClearOneRecipe = function onClearOneRecipe(event) {
	  event.preventDefault();
	  ui.clearOneRecipe();
	  $('#get-one-recipe-alert').text('type in the id of the recipe you\'d like to see');
	};

	var closeSignUpWindow = function closeSignUpWindow(event) {
	  event.preventDefault();
	  $('#sign-up-modal-alert').text('sign up!');
	};

	var closeSignInWindow = function closeSignInWindow(event) {
	  event.preventDefault();
	...
	var onCreateIngredient = function onCreateIngredient(event) {
	  ...
	  var data = getFormFields(this);
	  // $('#recipe-container').removeClass('hidden')
	  api.createIngredient(data).then(ui.createIngredientSuccess).catch(ui.createIngredientFailure);
	};
	...
	var onGetRecipe = function onGetRecipe(event) {
	  ...
	  var data = getFormFields(this);
	  $('#change-password-alert').addClass('hidden');
	  api.getRecipe(data.recipe.id).then(ui.getRecipeSuccess).catch(ui.getRecipeFailure);
	};

	var onExitCreateRecipeForm = function onExitCreateRecipeForm(event) {
	  event.preventDefault();
	...
	var hidePasswordAlert = function hidePasswordAlert(event) {
	  $('#change-password-alert').addClass('hidden');
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var createIngredient = function createIngredient(data) {
	...
	var updateRecipe = function updateRecipe(data, newRecipe) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(10);
	var api = __webpack_require__(9);
	var showRecipesTemplate = __webpack_require__(12);
	var showOneRecipeTemplate = __webpack_require__(32);
	var getFormFields = __webpack_require__(8);
	...
	var signInHideModals = function signInHideModals() {
	...
	var signInShowModals = function signInShowModals() {
	...
	var signOutHideModals = function signOutHideModals() {
	...
	var noEmptyUpdates = function noEmptyUpdates(input) {
	...
	var onUpdateRecipe = function onUpdateRecipe(event) {
	  ...
	  // console.log(data)
	  var newRecipe = $(event.target).attr('data-id');
	  // console.log('event.target is ' + data)
	  // console.log(newRecipe)
	  $('.update').trigger('reset');
	  refreshRecipesList();
	  if (noEmptyUpdates(data.recipe.name) === true) {
	    api.updateRecipe(data, newRecipe).then(updateRecipeSuccess).then(function () {
	      api.getAllRecipes().then(getAllRecipesSuccess).catch(getAllRecipesFailure);
	    });
	  } else {
	    updateRecipeFailure;
	...
	var refreshRecipesList = function refreshRecipesList(data) {
	  var showRecipesHtml = showRecipesTemplate({ recipes: store.recipeLists });
	  $('.content').empty();
	...
	var onDeleteRecipe = function onDeleteRecipe(event) {
	  ...
	  $('#change-password-alert').addClass('hidden');
	  var removeRecipe = $(event.target).attr('data-id');
	  store.recipeLists = store.recipeLists.filter(function (recipe) {
	    return String(recipe.id) !== String(removeRecipe);
	  });
	  refreshRecipesList();
	  api.deleteRecipe(removeRecipe).then(deleteRecipeSuccess).catch(deleteRecipeFailure).then(function () {
	    api.getAllRecipes().then(getAllRecipesSuccess).catch(getAllRecipesFailure);
	  });
	  // .catch(updateRecipeFailure)
	};

	var getAllRecipesSuccess = function getAllRecipesSuccess(data) {
	  // console.log(data)
	...
	var getAllRecipesFailure = function getAllRecipesFailure(error) {
	  console.error(error);
	};
	...
	var clearOneRecipe = function clearOneRecipe() {
	...
	var createIngredientSuccess = function createIngredientSuccess(response) {
	...
	var createIngredientFailure = function createIngredientFailure(error) {
	  console.error(error);
	};
	...
	var getRecipeSuccess = function getRecipeSuccess(data) {
	  ...
	  var showOneRecipeHtml = showOneRecipeTemplate({ recipe: data.recipe });
	  $('.one-recipe-content').html(showOneRecipeHtml);
	  $('#change-password-alert').addClass('hidden');
	};

	var getRecipeFailure = function getRecipeFailure(error) {
	  console.error(error);
	...
	var deleteRecipeSuccess = function deleteRecipeSuccess(data) {
	...
	module.exports = {
	  ...
	  getAllRecipesSuccess: getAllRecipesSuccess,
	  getAllRecipesFailure: getAllRecipesFailure,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div data-id=\""
	    ...
	    + "\" class=\"recipe-post\">\n    <ul style=\"list-style-type: none;\">\n      <li><h4>How to make <strong>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</strong></h4></li>\n      <li class=\"desc\"><strong>Description:</strong> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</li>\n      <li class=\"desc\"><strong>Servings:</strong> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.servings : stack1), depth0))
	    + "</li>\n      <li class=\"desc\"><strong>Recipe ID:</strong> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</li>\n  </ul>\n  <form class=\"update\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n    <div class=\"container-fluid\">\n      <br>\n       <input class=\"form-control handlebars-update\" type=\"text\" name=\"recipe[name]\" id=\"handlebars-recipe-name\" placeholder=\"update recipe name\">\n       <br>\n       <div class=\"form-group\">\n     <textarea class=\"form-control handlebars-update\" name=\"recipe[description]\" id=\"handlebars-recipe-desc\" rows=\"7\" placeholder=\"update description and ingredients here\"></textarea>\n    </div>\n    <div class=\"form-group\">\n      <input class=\"form-control handlebars-update\" name=\"recipe[servings]\" id=\"handlebars-recipe-servings\" type=\"text\" value=\"\" placeholder=\"update serving size\">\n    </div>\n    <input type=\"submit\" class=\"btn btn-default\" name=\"submit\" value=\"update\">\n    <br>\n    <div class=\"destroy\">\n      <br>\n       <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" id=\"red-button\" class=\"btn btn-danger\" value=\"delete\">delete</button>\n     </div>\n    </form>\n   </div>\n </div>\n\n<br>\n\n   <!-- <div class=\"container-fluid destroy\">\n      <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default\" value=\"delete\">delete</button>\n    </div> -->\n</div>\n</div>\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <div data-id=\""
	    ...
	    + "\">\n    <ul style=\"list-style-type: none;\">\n      <li><h4>This is your recipe for <strong>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</strong></h4></li>\n      <li class=\"desc\"><p><strong>Description:</strong> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.description : stack1), depth0))
	    + "</p></li>\n      <li class=\"desc\"><p><strong>Servings:</strong> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.servings : stack1), depth0))
	    + "</p></li>\n      <li class=\"desc\"><p><strong>Recipe ID:</strong> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.recipe : depth0)) != null ? stack1.id : stack1), depth0))
	    + "</p></li>\n  </ul>\n   </div>\n";
	},"useData":true});
